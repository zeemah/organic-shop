        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                <div class="hidden w-full text-white md:flex md:items-center">
                    ...
                    <span class="mx-1 text-sm">NG</span>
                </div>
                <div class="w-full text-gray-700 md:text-center text-2xl font-semibold">
                   <img src="~/assets/img/organic.png" width="200" class="justify-center lg:ml-32"/>
                </div>
                <div class="flex items-center justify-end w-full">
                    <NuxtLink to="/cart"  class="text-gray-200 focus:outline-none mx-4 sm:mx-0">
            ...
            <!-- <hr class="mt-5 bg-gray-800"> -->
            <nav class="sm:flex sm:justify-center sm:items-center mt-4">
                <div class="flex flex-col sm:flex-row">
                    <a class="mt-3 text-white text-xl hover:text-yellow-500 sm:mx-3 sm:mt-0" href="#">Home</a>
                    <a class="mt-3 text-white text-xl hover:text-yellow-500 sm:mx-3 sm:mt-0" href="#">Shop</a>
                    <a class="mt-3 text-white text-xl hover:text-yellow-500 sm:mx-3 sm:mt-0" href="#">Categories</a>
                    <a class="mt-3 text-white text-xl hover:text-yellow-500 sm:mx-3 sm:mt-0" href="#">Contact</a>
                    <a class="mt-3 text-white text-xl hover:text-yellow-500 sm:mx-3 sm:mt-0" href="#">About</a>
                </div>
            </nav>
